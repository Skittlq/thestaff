...
public final class GameIconItemGlowRenderer implements SpecialModelRenderer<Boolean> {

    private static final ResourceLocation GLOW_TEX =
            ResourceLocation.fromNamespaceAndPath("thestaff", "textures/misc/glow.png");
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        @Override public SpecialModelRenderer<?> bake(EntityModelSet set) { return new GameIconItemGlowRenderer(); }
